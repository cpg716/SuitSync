                ...
                <tr key={party.id} className="border-t hover:bg-gray-light dark:hover:bg-gray transition">
                  <td className="p-2 font-medium text-lg flex items-center gap-2">
                    <span className="inline-block">
                      <Link legacyBehavior href={`/parties/${party.id}`}>
                        <a className="hover:underline text-primary dark:text-accent">{party.name}</a>
                      </Link>
                    </span>
                  </td>
                  ...
                  <td className="p-2 flex gap-2">
                    <Link legacyBehavior href={`/parties/${party.id}`}>
                      <a className="text-primary underline mr-2 dark:text-accent">View</a>
                    </Link>

...
function Checkbox({ checked, label }: { checked: boolean; label: string }) {
  return (
    <span className="inline-flex items-center mr-3 mb-1">
      <span className={`inline-block w-4 h-4 border-2 border-gray-700 rounded-sm mr-1 bg-white ${checked ? 'bg-blue-500 border-blue-600' : ''}`}></span>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-x-4 mb-2">
                    <Checkbox checked={!!alt.sleevesShorten} label="SHORTEN" />
                    <Checkbox checked={!!alt.sleevesLengthen} label="LENGTHEN" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-x-4 mb-2">
                    <Checkbox checked={!!alt.sidesTakeIn} label="TAKE IN" />
                    <Checkbox checked={!!alt.sidesLetOut} label="LET OUT" />
                    <Checkbox checked={!!alt.reduceFront} label="REDUCE FRONT" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-wrap gap-x-4">
                      ...
                      <Checkbox checked={!!alt.waistTakeIn} label="TAKE IN" />
                      <Checkbox checked={!!alt.waistLetOut} label="LET OUT" />
                    </div>
                    <div className="flex flex-wrap gap-x-4">
                      <span className="text-sm font-bold w-16">SEAT:</span>
                      <Checkbox checked={!!alt.seatTakeIn} label="TAKE IN" />
                      <Checkbox checked={!!alt.seatLetOut} label="LET OUT" />
                    </div>
                    <div className="flex flex-wrap gap-x-4">
                      <span className="text-sm font-bold w-16">CROTCH:</span>
                      <Checkbox checked={!!alt.crotchTakeIn} label="TAKE IN" />
                      <Checkbox checked={!!alt.crotchLetOut} label="LET OUT" />
                    </div>
                    <div className="flex flex-wrap gap-x-4">
                      <span className="text-sm font-bold w-16">BOTTOM:</span>
                      <Checkbox checked={!!alt.bottomPlain} label="PLAIN" />
                      <Checkbox checked={!!alt.bottomCuff} label="CUFF" />
                      <Checkbox checked={!!alt.bottomJean} label="JEAN" />
                    </div>
                  </div>
                </div>
              </div>

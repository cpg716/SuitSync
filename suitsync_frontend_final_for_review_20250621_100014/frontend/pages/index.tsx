                ...
                <>
                  ...
                  {todaysAppts.length > 5 && (
                    <div className="mt-2 flex justify-end">
                      <Link href="/appointments" className="text-primary dark:text-accent underline text-sm font-medium">View All</Link>
                    </div>
                  )}
                </>
              )}
            ...
            <Card title="Today's Alterations">
              {metrics === null ? <Skeleton className="h-24 w-full" /> : (
                ...
                <>
                  ...
                  {todaysAlts.length > 5 && (
                    <div className="mt-2 flex justify-end">
                      <Link href="/alterations" className="text-primary dark:text-accent underline text-sm font-medium">View All</Link>
                    </div>
                  )}
                </>
              )}

  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      <div className="mb-6 flex justify-between items-center">
        <h1 className="text-3xl font-bold text-primary">Alterations Calendar</h1>
          ...
          <div className="calendar-wrapper dark:text-white">
            <Calendar
              ...
              tooltipAccessor={(event: any) => {
                ...
                const priority = String(event.resource.priority || 'N/A');
                const tailor = String(event.resource.tailor?.name || 'Unassigned');
